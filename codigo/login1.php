...
'<html><head><style>
body{
background-image:url(estilo/rondon/imagens/organizacao/10/daelogo3.jpg);
...
if (!$celular) {
	echo '<br><center>'.dica('Site do '.$config['gpweb'], 'Clique para entrar no site oficial do '.$config['gpweb'].'.').'<a href="'.((isset($config['endereco_site']) && $config['endereco_site']) ? $config['endereco_site'] : get_protocol().'www.dae.ce.gov.br').'" target="_blank"><img src="'.$Aplic->gpweb_logo.'" border=0 /></a>'.dicaF().'<center>';
 	echo '<br><br>';
 	}
...
echo '<tr><td align=center><h3>Utilize somente navegadores Chrome ou Firefox.</h3></td></tr><br>';
...
<table style="text-align: left; width: 250px;" border="1"
 cellpadding="2" cellspacing="2">
  <tbody>
    ...
    <tr align="center">
      <td style="width: 109px; background-color: rgb(242, 240, 236);"
 colspan="2" rowspan="1"><span
 style="font-weight: bold;">Manuais GPSOP</span></td>
    </tr>
	
	 <tr>
      <td
 style="width: 31px; text-align: center; background-color: rgb(242, 240, 236);"><a
 href="/manuais/Desbloqueio.pdf" target="_blank"><img
 style="border: 0px solid ; width: 20px; height: 20px;" alt=""
 src="/estilo/rondon/imagens/arquivo.png"></a></td>
      <td style="width: 109px; background-color: rgb(242, 240, 236);">Desbloqueio de Pop-up</td>
    </tr>	
    <tr>
      <td
 style="width: 31px; text-align: center; background-color: rgb(242, 240, 236);"><a
 href="/manuais/manual_projetos.pdf" target="_blank"><img
 style="border: 0px solid ; width: 20px; height: 20px;" alt=""
 src="/estilo/rondon/imagens/arquivo.png"></a></td>
      <td style="width: 109px; background-color: rgb(242, 240, 236);">Projetistas</td>
    </tr>
    ...
    <tr>
      <td
 style="width: 31px; text-align: center; background-color: rgb(242, 240, 236);"><a
 href="/manuais/manual_fiscal.pdf" target="_blank"><img
 style="border: 0px solid ; width: 20px; height: 20px;" alt=""
 src="/estilo/rondon/imagens/arquivo.png"></a></td>
      <td style="width: 109px; background-color: rgb(242, 240, 236);">Fiscaliza&ccedil;&atilde;o</td>
    </tr>
    <tr>
      <td
 style="width: 31px; text-align: center; background-color: rgb(242, 240, 236);"><a
 href="/manuais/manual_construtora.pdf" target="_blank"><img
 style="border: 0px solid ; width: 20px; height: 20px;" alt=""
 src="/estilo/rondon/imagens/arquivo.png"></a></td>
      <td style="width: 109px; background-color: rgb(242, 240, 236);">Construtora</td>
    </tr>
  </tbody>
</table>
<br>
