...
echo '<th style="white-space: nowrap"><b>'.dica('Status', 'Status d'.$config['genero_tarefa'].' '.$config['tarefa'].'.').'Status'.dicaF().'</b></th>';
...
function popLog(tarefa_id) {
	...
	else window.open('./index.php?m=tarefas&a=ver_log_atualizar&dialogo=1&projeto_id=<?php echo $projeto_id ?>&tarefa_id='+tarefa_id, 'Registro','height=822,width=800px,resizable,scrollbars=no');
	}	
