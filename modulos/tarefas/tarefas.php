...
global $envolvimento, $m, $a, $projeto_id, $f, $ver_min, $texto_consulta, $tipoDuracao, $cia_id, $dept_id, $lista_depts, $lista_cias, $mostrar_marcada, $inativo,
...
$titulos .= '<th style="white-space: nowrap" width="120"><b>'.dica('Status', 'Status das tarefas.').'Status'.dicaF().'</b></th>';
