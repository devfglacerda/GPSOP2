...
global $envolvimento, $selecao, $chamarVolta, $selecionado, $edicao, $a, $estilo_interface, $dialogo, $tab, $cia_id, $dept_id, $lista_depts, $lista_cias, $pesquisar_texto, $podeEditar, $projeto_abertura_setor, $projeto_abertura_segmento, $projeto_abertura_intervencao, $projeto_abertura_tipo_intervencao, $responsavel,
	$projeto_id,
	$tarefa_id,
	$pg_perspectiva_id,
	$tema_id,
...
if ($a!='termo_abertura_lista') $sql->adOnde('projeto_abertura_ativo=1'); 	
elseif ($tab==0) $sql->adOnde('projeto_abertura_aprovado=0');	
...
else $sql->adGrupo('projeto_abertura.projeto_abertura_id');
