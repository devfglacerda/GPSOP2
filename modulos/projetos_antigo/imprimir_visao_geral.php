...
function corpo_cabecalho(){
	...
	if ($temTarefas) {
	  ...
	  $sql->esqUnir(($baseline_id ? 'baseline_' : '').'tarefas','tarefas', 'log_tarefa = tarefa_id');
	...
	$sql->esqUnir(($baseline_id ? 'baseline_' : '').'log', 'tlog', 'tlog.log_tarefa = tarefas.tarefa_id AND tlog.log_corrigir > 0');
	...
	$sql->adTabela(($baseline_id ? 'baseline_' : '').'log','log');
	$sql->esqUnir(($baseline_id ? 'baseline_' : '').'tarefas', 't', 'log_tarefa = t.tarefa_id');
