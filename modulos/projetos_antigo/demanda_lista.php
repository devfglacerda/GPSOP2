...
if (!$dialogo || $selecao){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$novo=($Aplic->checarModulo('projetos', 'adicionar', $Aplic->usuario_id, 'demanda') ? '<tr><td style="white-space: nowrap">'.dica('Nova Demanda', 'Criar um nova demanda.').'<a href="javascript: void(0)" onclick="javascript:env.a.value=\'demanda_editar\'; env.submit();" ><img src="'.acharImagem('demanda_novo.png').'" border=0 width="16" heigth="16" /></a>'.dicaF().'</td></tr><tr><td style="white-space: nowrap"></td></tr>' : '');
