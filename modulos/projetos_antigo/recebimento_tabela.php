...
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=projeto_recebimento_numero&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='projeto_recebimento_numero' ? imagem('icones/'.$seta[$ordem]) : '').dica('Número do recebimento', 'Neste campo fica a número do recebimento.').'Número'.dicaF().'</a></th>';
