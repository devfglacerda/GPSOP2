...
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=projeto_mudanca_data&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='projeto_mudanca_data' ? imagem('icones/'.$seta[$ordem]) : '').dica('Data', 'Neste campo fica a data da solicitação de mudança.').'Data'.dicaF().'</a></th>';
