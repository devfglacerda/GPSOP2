...
if (!$dialogo){
	...
	if ($podeAdicionar && $editar) $botoesTitulo->adicionaCelula('<table><tr><td><td style="white-space: nowrap">'.dica('Nova Ata de Reunião', 'Criar um nova ata de reunião.').'<a class="botao" href="javascript: void(0)" onclick="javascript:url_passar(0, \'m=projetos&a=ata_editar&projeto_id='.$projeto_id.'\');" ><span>nova ata de reunião</span></a>'.dicaF().'</td></td></tr></table>');
