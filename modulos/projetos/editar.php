...
echo '<tr style="display:none"><td align="right" style="white-space: nowrap">'.
dica(ucfirst($config['organizacao']).' Responsável', 'Selecionar '.$config['genero_organizacao'].' '.$config['organizacao'].' que será encarregad'.$config['genero_organizacao'].' d'.($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto']).'.').
ucfirst($config['organizacao']).' responsável:'.dicaF().'</td><td width="100%" style="white-space: nowrap" colspan="2"><div id="combo_cia">'.selecionar_om($linha->projeto_cia, 'projeto_cia', 'class=texto size=1 style="width:400px;" onchange="javascript:mudar_om();"').'</div></td></tr>';
...
//if ($exibir['projeto_regiao']) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['projeto_regiao']), ucfirst($config['projeto_regiao']).' '.($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto']).'.').ucfirst($config['projeto_regiao']).':'.dicaF().'</td><td colspan="2"><input type="Text" name="projeto_regiao" value="'.$linha->projeto_regiao.'" style="width:400px;" maxlength="255" class="texto" /></td></tr>';
...
echo '<tr style="display:none"><td align="right">'.
    dica(
        'Status',
        'Definir o Status d'.($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto']).'.'
    ).
    'Status:'.dicaF().
    '</td><td>'.
    selecionaVetor($projStatus, 'projeto_status', 'style="width:400px;" size="1" class="texto"', $linha->projeto_status).
    '</td></tr>';
...
if (count($integrantes)) {
	echo '<table cellspacing=0 cellpadding=0 class="tbl1" align=left><tr><th></th><th>'.dica('Nome', 'Nome do contato d'.($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto']).' que tem envolvimento. No caso de inserção de dados n'.($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto']).' poderão ser informados automaticamente por e-mail.').'Nome'.dicaF().'</th><th>Função</th><th>Competência</th><th></th><th></th><th></th></tr>';
...
echo '<tr id="notificar" style="display:'.($Aplic->getPref('informa_fechado') ? '' : 'none').'"><td colspan=20><table width="100%" cellspacing=1 cellpadding=0>';

echo '<tr><td valign="middle" align="right" width=130>'
    .dica('Notificar', 'Marque esta caixa para avisar da '.($projeto_id > 0 ? 'modificação' : 'criação').' '
    .($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto']).'.')
    .'Notificar:'.dicaF().'</td><td>';

echo '<input type="checkbox" name="email_projeto_responsavel_box" id="email_projeto_responsavel_box" />'
    .dica(ucfirst($config['gerente']), 'Ao selecionar esta opção, o '.$config['gerente'].' d'
    .($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto'])
    .' será informado '.($projeto_id > 0 ? 'das alterações realizadas.' : 'da criação.'))
    .ucfirst($config['gerente']).dicaF().'&nbsp;&nbsp;&nbsp;&nbsp;';	

echo '<input type="checkbox" name="email_projeto_supervisor_box" id="email_projeto_supervisor_box" checked="checked" />'
    .dica(ucfirst($config['supervisor']), 'Ao selecionar esta opção, o '.$config['supervisor'].' d'
    .($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto'])
    .' será informado '.($projeto_id > 0 ? 'das alterações realizadas.' : 'da criação.'))
    .ucfirst($config['supervisor']).dicaF().'&nbsp;&nbsp;&nbsp;&nbsp;';

echo '<input type="checkbox" name="email_projeto_autoridade_box" id="email_projeto_autoridade_box" />'
    .dica(ucfirst($config['autoridade']), 'Ao selecionar esta opção, o '.$config['autoridade'].' d'
    .($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto'])
    .' será informado '.($projeto_id > 0 ? 'das alterações realizadas.' : 'da criação.'))
    .ucfirst($config['autoridade']).dicaF().'&nbsp;&nbsp;&nbsp;&nbsp;';

echo '<input type="checkbox" name="email_projeto_cliente_box" id="email_projeto_cliente_box" checked="checked" />'
    .dica(ucfirst($config['cliente']), 'Ao selecionar esta opção, o '.$config['cliente'].' d'
    .($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto'])
    .' será informado '.($projeto_id > 0 ? 'das alterações realizadas.' : 'da criação.'))
    .ucfirst($config['cliente']).dicaF().'&nbsp;&nbsp;&nbsp;&nbsp;';

echo '<input type="checkbox" name="email_projeto_designados_box" id="email_projeto_designados_box" />'
    .dica('Integrantes', 'Ao selecionar esta opção, os integrantes d'
    .($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto'])
    .' serão informados '.($projeto_id > 0 ? 'das alterações realizadas.' : 'da criação.'))
    .'Integrantes'.dicaF().'&nbsp;&nbsp;&nbsp;&nbsp;';

echo '<input type="checkbox" name="email_projeto_stakeholder_box" id="email_projeto_stakeholder_box" />'
    .dica('Stakeholders', 'Ao selecionar esta opção, os stakeholders d'
    .($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto'])
    .' serão informados '.($projeto_id > 0 ? 'das alterações realizadas.' : 'da criação.'))
    .'Stakeholders'.dicaF().'&nbsp;&nbsp;&nbsp;&nbsp;';

echo '<input type="checkbox" name="email_projeto_contatos_box" id="email_projeto_contatos_box" />'
    .dica('Contatos', 'Ao selecionar esta opção, os contatos d'
    .($linha->projeto_portfolio ? $config['genero_portfolio'].' '.$config['portfolio'] : $config['genero_projeto'].' '.$config['projeto'])
    .' serão informados '.($projeto_id > 0 ? 'das alterações realizadas.' : 'da criação.'))
    .'Contatos'.dicaF();
...
function popProjeto2() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp("<?php echo ucfirst($config['projeto']) ?>", 610, 500, 'm=publico&a=selecionar&dialogo=1&chamar_volta=setProjeto&aceita_portfolio=1&tabela=projetos&cia_id='+document.getElementById('projeto_cia').value, window.setProjeto2, window);
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setProjeto2&aceita_portfolio=1&tabela=projetos', 'Projeto','left=0,top=0,height=700,width=700,scrollbars=yes, resizable=yes');
	}
...
function expandir_colapsar(campo){
	...
	function popProjetoPortfolio() {
		...
		else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setProjetoPortfolio&aceita_portfolio=1&tabela=projetos&projeto_id='+document.getElementById('projeto_id').value, 'Projeto','left=0,top=0,height=700,width=700,scrollbars=yes, resizable=yes');
		*/
...
function popPerspectiva() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["perspectiva"])?>', 1000, 700, 'm=praticas&a=perspectiva_lista&dialogo=1&edicao=1&selecao=1&chamarVolta=setPerspectiva&tabela=perspectivas&cia_id='+document.getElementById('projeto_cia').value, window.setPerspectiva, window);
...
function popTema() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["tema"])?>', 1000, 700, 'm=praticas&a=tema_lista&dialogo=1&edicao=1&selecao=1&chamarVolta=setTema&tabela=tema&cia_id='+document.getElementById('projeto_cia').value, window.setTema, window);
...
function popObjetivo() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["objetivo"])?>', 1000, 700, 'm=praticas&a=obj_estrategico_lista&dialogo=1&edicao=1&selecao=1&chamarVolta=setObjetivo&tabela=objetivo&cia_id='+document.getElementById('projeto_cia').value, window.setObjetivo, window);
...
function popFator() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["fator"])?>', 1000, 700, 'm=praticas&a=fator_lista&dialogo=1&edicao=1&selecao=1&chamarVolta=setFator&tabela=fator&cia_id='+document.getElementById('projeto_cia').value, window.setFator, window);
...
function popEstrategia() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["iniciativa"])?>', 1000, 700, 'm=praticas&a=estrategia_lista&dialogo=1&edicao=1&selecao=1&chamarVolta=setEstrategia&tabela=estrategias&cia_id='+document.getElementById('projeto_cia').value, window.setEstrategia, window);
...
function popMeta() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["meta"])?>', 1000, 700, 'm=praticas&a=meta_lista&dialogo=1&edicao=1&selecao=1&chamarVolta=setMeta&tabela=metas&cia_id='+document.getElementById('projeto_cia').value, window.setMeta, window);
...
function popPDCLItem() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["pdcl_item"])?>', 1000, 700, 'm=pdcl&a=pdcl_item_lista&dialogo=1&edicao=1&selecao=1&chamarVolta=setPDCLItem&tabela=pdcl_item&cia_id='+document.getElementById('projeto_cia').value, window.setPDCLItem, window);
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&edicao=1&chamar_volta=setPDCLItem&tabela=pdcl_item&cia_id='+document.getElementById('projeto_cia').value, '<?php echo ucfirst($config["pdcl_item"])?>','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
	}
