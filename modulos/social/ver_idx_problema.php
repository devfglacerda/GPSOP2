...
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=social_familia_nome&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='social_familia_nome' ? imagem('icones/'.$seta[$ordem]) : '').dica('Nome', 'Neste campo fica o nome d'.$config['genero_beneficiario'].' '.$config['beneficiario'].'.').'Nome'.dicaF().'</a></th>';
...
if (!$status_id) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.($a ? '&a='.$a : '').($tab ? '&tab='.$tab : '').'&ordenar=social_familia_problema_status&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='social_familia_problema_status' ? imagem('icones/'.$seta[$ordem]) : '').dica('Status', 'O status do problemao.').'Status'.dicaF().'</a></th>';
...
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.($a ? '&a='.$a : '').($tab ? '&tab='.$tab : '').'&ordenar=social_familia_problema_data_status&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='social_familia_problema_data_status' ? imagem('icones/'.$seta[$ordem]) : '').dica('Data', 'O data da última mudança de status.').'Data'.dicaF().'</a></th>';
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.($a ? '&a='.$a : '').($tab ? '&tab='.$tab : '').'&ordenar=social_familia_problema_observacao&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='social_familia_problema_observacao' ? imagem('icones/'.$seta[$ordem]) : '').dica('Observação', 'Observação sobre o problema.').'Observação'.dicaF().'</a></th>';
