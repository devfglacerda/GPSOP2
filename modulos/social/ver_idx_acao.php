...
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=social_acao_nome&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='social_acao_nome' ? imagem('icones/'.$seta[$ordem]) : '').dica('Nome da Ação Socia', 'Neste campo fica um nome para identificação da ação social.').'Nome'.dicaF().'</a></th>';
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=social_acao_descricao&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='social_acao_descricao' ? imagem('icones/'.$seta[$ordem]) : '').dica('Descrição da Ação Socia', 'Neste campo fica a descrição da ação social.').'Descrição'.dicaF().'</a></th>';
echo '</tr>';
$fp = -1;
$id = 0;
$qnt=0;
