...
function testar_circular($cia_original=null, $cia_superior=null){
	$achou_circular=0;
	circular($cia_original, $cia_superior, $achou_circular);
	$objResposta = new xajaxResponse();
...
function circular($cia_original=null, $cia_id=null, &$achou_circular){
		...
		elseif ($cia_superior==$cia_original){
			$achou_circular=1;
			return 1;
			}
		else circular($cia_original, $cia_superior, $achou_circular);	
		}
