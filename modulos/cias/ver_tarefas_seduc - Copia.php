...
if (!($linha = $sql->Lista())) {
	...
	echo '<th><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m=cias&a=ver_seduc&cia_id='.(int)$cia_id.'&tab='.$tab.'&ordenar=dept_nome&ordem='.($ordem ? '0' : '1').'\');">'. dica('Se��o', 'Clique para ordenar pelo setor.') .'Setor'.dicaF().'</a></th>';
