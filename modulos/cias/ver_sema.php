...
if (!$dialogo){
	$caixaTab = new CTabBox('m=cias&a=ver_sema&cia_id='.(int)$cia_id, '', $tab);
	
		$caixaTab->adicionar(BASE_DIR.'/modulos/cias/ver_tarefas_sema', 'DEMANDAS',null,null,'DEMANDAS','Visualizar as tarefas d'.$config['genero_organizacao'].' '.$config['organizacao'].'.');
