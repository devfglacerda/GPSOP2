...
if (!$dialogo){
	$caixaTab = new CTabBox('m=cias&a=ver_geral&cia_id='.(int)$cia_id, '', $tab);
	
	//$caixaTab->adicionar(BASE_DIR.'/modulos/cias/ver_tarefas_arquitetura', 'ARQUITETURA',null,null,'ARQUITETURA','Visualizar as tarefas d'.$config['genero_organizacao'].' '.$config['organizacao'].'.');
	
	
	$caixaTab->adicionar(BASE_DIR.'/modulos/cias/ver_tarefas_gerais', 'GERAL',null,null,'GERAL','Visualizar as tarefas d'.$config['genero_organizacao'].' '.$config['organizacao'].'.');
	/*$caixaTab->adicionar(BASE_DIR.'/modulos/cias/ver_tarefas_estrutura', 'ESTRUTURA',null,null,'ESTRUTURA','Visualizar as tarefas d'.$config['genero_organizacao'].' '.$config['organizacao'].'.');
	$caixaTab->adicionar(BASE_DIR.'/modulos/cias/ver_tarefas_mecanica', 'MECÂNICA',null,null,'MECÂNICA','Visualizar as tarefas d'.$config['genero_organizacao'].' '.$config['organizacao'].'.');
	$caixaTab->adicionar(BASE_DIR.'/modulos/cias/ver_tarefas_hidro', 'HIDROSSANITÁRIO',null,null,'HIDROSSANITÁRIO','Visualizar as tarefas d'.$config['genero_organizacao'].' '.$config['organizacao'].'.');
	$caixaTab->adicionar(BASE_DIR.'/modulos/cias/ver_tarefas_eletrica', 'ELÉTRICA',null,null,'ELÉTRICA','Visualizar as tarefas d'.$config['genero_organizacao'].' '.$config['organizacao'].'.');*/
	
		//$caixaTab->adicionar(BASE_DIR.'/modulos/cias/ver_tarefas_orcamento', 'ORÇAMENTO',null,null,'ORÇAMENTO','Visualizar as tarefas d'.$config['genero_organizacao'].' '.$config['organizacao'].'.');
