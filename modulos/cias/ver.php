...
if (!$dialogo){
	...
	$caixaTab->adicionar(BASE_DIR.'/modulos/cias/ver_tarefas_andamento', 'Tarefas em andamento',null,null,'Tarefas em andamento','Visualizar as tarefas d'.$config['genero_organizacao'].' '.$config['organizacao'].'.');
