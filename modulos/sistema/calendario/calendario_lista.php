...
if (!$dialogo || $selecao){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$nova_calendario=($podeAdicionar || $Aplic->usuario_admin ? '<tr><td style="white-space: nowrap" align=right>'.dica('Nova Agenda Coletiva'.'', 'Criar uma nova agenda coletiva.').'<a href="javascript: void(0)" onclick="javascript:env.a.value=\'calendario_editar\'; env.submit();" ><img src="'.acharImagem('agenda_novo.png').'" border=0 width="16" heigth="16" /></a>'.dicaF().'</td></tr>' : '');
	$imprimir='<tr><td align="right" style="white-space: nowrap">'.dica('Imprimir '.'Agenda Coletiva'.'', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista de agenda coletiva.').'<a href="javascript: void(0);" onclick ="url_passar(1, \'m='.$m.'&a='.$a.'&dialogo=1&tab='.$tab.'\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
