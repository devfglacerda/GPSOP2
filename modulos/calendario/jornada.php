...
function popProjeto() {
	...
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setProjeto&aceita_portfolio=1&tabela=projetos&projeto_id='+document.getElementById('projeto_id').value, 'Projetos','left=0,top=0,height=700,width=700,scrollbars=yes, resizable=yes');
	}
