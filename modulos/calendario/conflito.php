...
if (getParam($_REQUEST, 'aceitar', null)){
	...
	if (getParam($_REQUEST, 'uuid', null)){
		...
		elseif ($linha['evento_gestao_risco'] && $qnt==1) $endereco='m=praticas&a=risco_pro_ver&risco_id='.$linha['evento_gestao_risco'];
		elseif ($linha['evento_gestao_risco_resposta'] && $qnt==1) $endereco='m=praticas&a=risco_resposta_pro_ver&risco_resposta_id='.$linha['evento_gestao_risco_resposta'];
		...
		elseif ($linha['evento_gestao_operativo'] && $qnt==1) $endereco='m=operativo&a=operativo_ver&operativo_id='.$linha['evento_gestao_operativo'];
		...
		elseif ($linha['evento_gestao_licao'] && $qnt==1) $endereco='m=projetos&a=licao_ver&licao_id='.$linha['evento_gestao_licao'];
		
		elseif ($linha['evento_gestao_semelhante'] && $qnt==1) $endereco='m=calendario&a=ver&evento_id='.$linha['evento_gestao_semelhante'];
		...
		elseif ($linha['evento_gestao_brainstorm'] && $qnt==1) $endereco='m=praticas&a=brainstorm_ver&brainstorm_id='.$linha['evento_gestao_brainstorm'];
		elseif ($linha['evento_gestao_gut'] && $qnt==1) $endereco='m=praticas&a=gut_ver&gut_id='.$linha['evento_gestao_gut'];
		elseif ($linha['evento_gestao_causa_efeito'] && $qnt==1) $endereco='m=praticas&a=causa_efeito_ver&causa_efeito_id='.$linha['evento_gestao_causa_efeito'];
		...
		elseif ($linha['evento_gestao_acao_item'] && $qnt==1) $endereco='m=praticas&a=plano_acao_item_ver&plano_acao_item_id='.$linha['evento_gestao_acao_item'];
		elseif ($linha['evento_gestao_beneficio'] && $qnt==1) $endereco='m=projetos&a=beneficio_pro_ver&beneficio_id='.$linha['evento_gestao_beneficio'];
		elseif ($linha['evento_gestao_painel_slideshow'] && $qnt==1) $endereco='m=praticas&a=painel_slideshow_pro_ver&jquery=1&painel_slideshow_id='.$linha['evento_gestao_painel_slideshow'];
		elseif ($linha['evento_gestao_projeto_viabilidade'] && $qnt==1) $endereco='m=projetos&a=viabilidade_ver&projeto_viabilidade_id='.$linha['evento_gestao_projeto_viabilidade'];
		elseif ($linha['evento_gestao_projeto_abertura'] && $qnt==1) $endereco='m=projetos&a=termo_abertura_ver&projeto_abertura_id='.$linha['evento_gestao_projeto_abertura'];
		elseif ($linha['evento_gestao_plano_gestao'] && $qnt==1) $endereco='m=praticas&u=gestao&a=menu&pg_id='.$linha['evento_gestao_plano_gestao'];
