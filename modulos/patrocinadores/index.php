...
if (!$dialogo || $selecao){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$novo_patrocinador=($podeAdicionar ? '<tr><td style="white-space: nowrap">'.dica('Nov'.$config['genero_patrocinador'].' '.ucfirst($config['patrocinador']), 'Criar nov'.$config['genero_patrocinador'].' '.$config['patrocinador'].'.').'<a href="javascript: void(0)" onclick="javascript:env.a.value=\'patrocinador_editar\'; env.submit();" >'.imagem('../../../modulos/patrocinadores/imagens/patrocinador_novo.png').'</a>'.dicaF().'</td></tr><tr><td style="white-space: nowrap"></td></tr>' : '');
	$imprimir='<tr><td align="right" style="white-space: nowrap">'.dica('Imprimir', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista de '.$config['patrocinadores'].'.').'<a href="javascript: void(0);" onclick ="url_passar(1, \'m='.$m.'&a='.$a.'&dialogo=1\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
