...
echo '<th style="white-space: nowrap" width="140">'.dica('Status', 'Clique para ordenar '.$config['genero_tarefa'].'s '.$config['tarefas'].' abaixo pelo status.').ordenar_por_item_titulo('Status', 'tarefa_status', SORT_NUMERIC, '&a=parafazer').dicaF().'</th>';
