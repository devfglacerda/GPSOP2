...
$sql->esqUnir(($baseline_id ? 'baseline_': '').'tarefas','tarefas', 'projetos.projeto_id=tarefas.tarefa_projeto');
if ($baseline_id) {
...
$sql->esqUnir(($baseline_id ? 'baseline_': '').'log', 'log_corrigiu', 'log_corrigiu.log_id=log.log_correcao');
$sql->esqUnir(($baseline_id ? 'baseline_': '').'log', 'log_corrigido', 'log_corrigido.log_correcao=log.log_id');
$sql->esqUnir(($baseline_id ? 'baseline_': '').'tarefas','t', 'log.log_tarefa=t.tarefa_id');
if ($baseline_id) {
	$sql->adOnde('log.baseline_id ='.(int)$baseline_id);
