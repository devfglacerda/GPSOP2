...
if (isset($_REQUEST['tab'])) $Aplic->setEstado('ListaBrainstormTab', getParam($_REQUEST, 'tab', null));
$tab = ($Aplic->getEstado('ListaBrainstormTab') !== null ? $Aplic->getEstado('ListaBrainstormTab') : 0);
...
if (!$dialogo || $selecao){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$imprimir='<tr><td align="right" style="white-space: nowrap">'.dica('Imprimir', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista de brainstorms.').'<a href="javascript: void(0);" onclick ="url_passar(1, \'m='.$m.'&a='.$a.'&dialogo=1&tab='.$tab.'\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
