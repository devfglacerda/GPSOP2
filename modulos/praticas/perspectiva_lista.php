...
if (!$dialogo|| $selecao){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$imprimir='<tr><td align="right" style="white-space: nowrap">'.dica('Imprimir '.ucfirst($config['perspectivas']).'', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista de '.$config['perspectivas'].'.').'<a href="javascript: void(0);" onclick ="url_passar(1, \'m='.$m.'&a='.$a.'&dialogo=1&tab='.$tab.'\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
...
function popRecurso() {
	...
	else window.open('./index.php?m=publico&a=selecionar_multiplo&dialogo=1&edicao=1&chamar_volta=setRecurso&tabela=recursos&cia_id='+document.getElementById('cia_id').value, 'Recurso','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
	}
