...
if ($obj->pg_perspectiva_dept) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['departamento']).' Responsável', ucfirst($config['genero_dept']).' '.$config['departamento'].' responsável por '.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].'.').ucfirst($config['departamento']).' responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_secao($obj->pg_perspectiva_dept).'</td></tr>';
$saida_depts='';
