...
if (isset($_REQUEST['tab'])) $Aplic->setEstado('ListaGutTab', getParam($_REQUEST, 'tab', null));
$tab = ($Aplic->getEstado('ListaGutTab') !== null ? $Aplic->getEstado('ListaGutTab') : 0);
