...
if (isset($_REQUEST['tab'])) $Aplic->setEstado('ListaCausa_efeitoTab', getParam($_REQUEST, 'tab', null));
$tab = ($Aplic->getEstado('ListaCausa_efeitoTab') !== null ? $Aplic->getEstado('ListaCausa_efeitoTab') : 0);
...
if (!$dialogo || $selecao){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$imprimir='<tr><td align="right" style="white-space: nowrap">'.dica('Imprimir', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista de causas-efeitos.').'<a href="javascript: void(0);" onclick ="url_passar(1,\'m='.$m.'&a='.$a.'&dialogo=1\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
