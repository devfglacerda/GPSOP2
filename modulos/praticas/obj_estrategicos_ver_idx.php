...
global $envolvimento, $selecao, $chamarVolta, $selecionado, $edicao, $estilo_interface, $Aplic, $pesquisar_texto, $usuario_id, $cia_id, $dept_id, $lista_depts, $lista_cias, $tab, $filtro_pg_id, $favorito_id, $dialogo, $filtro_prioridade_objetivo,
	$projeto_id,
	$tarefa_id,
	$pg_perspectiva_id,
	$tema_id,
...
if ($tab==0 || $a!='obj_estrategico_lista') $sql->adOnde('objetivo_ativo=1');
...
if ($exibir['objetivo_aprovado'] && $Aplic->profissional) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_aprovado&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_aprovado' ? imagem('icones/'.$seta[$ordem]) : '').dica('Aprovado', 'Neste campo consta se foi aprovado.').'Ap.'.dicaF().'</a></th>';
if ($filtro_prioridade_objetivo) echo '<th style="white-space: nowrap"><a href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.($tab ? '&tab='.$tab : '').'&a='.$a.'&ordenar=priorizacao&ordem='.($ordem ? '0' : '1').'\');" class="hdr">'.dica('Priorização', 'Clique para ordenar pela priorização.').($ordenar=='priorizacao' ? imagem('icones/'.$seta[$ordem]) : '').'Prio.'.dicaF().'</a></th>';
...
if ($exibir['objetivo_oque']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_oque&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_oque' ? imagem('icones/'.$seta[$ordem]) : '').dica('O Que', 'Neste campo fica o que fazer d'.$config['genero_objetivo'].' '.$config['objetivo'].'.').'O Que'.dicaF().'</a></th>';
if ($exibir['objetivo_onde']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_onde&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_onde' ? imagem('icones/'.$seta[$ordem]) : '').dica('Onde ', 'Neste campo fica onde fazer '.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Onde'.dicaF().'</a></th>';
if ($exibir['objetivo_quando']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_quando&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_quando' ? imagem('icones/'.$seta[$ordem]) : '').dica('Quando', 'Neste campo fica quando fazer '.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Quando'.dicaF().'</a></th>';
if ($exibir['objetivo_como']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_como&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_como' ? imagem('icones/'.$seta[$ordem]) : '').dica('Como', 'Neste campo fica como fazer '.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Como'.dicaF().'</a></th>';
if ($exibir['objetivo_porque']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_porque&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_porque' ? imagem('icones/'.$seta[$ordem]) : '').dica('Por Que', 'Neste campo fica por que fazer '.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Por Que'.dicaF().'</a></th>';
if ($exibir['objetivo_quanto']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_quanto&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_quanto' ? imagem('icones/'.$seta[$ordem]) : '').dica('Quanto', 'Neste campo fica quanto custa '.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Quanto'.dicaF().'</a></th>';
if ($exibir['objetivo_quem']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_quem&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_quem' ? imagem('icones/'.$seta[$ordem]) : '').dica('Quem', 'Neste campo fica quem faz '.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Quem'.dicaF().'</a></th>';
if ($exibir['objetivo_controle']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_controle&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_controle' ? imagem('icones/'.$seta[$ordem]) : '').dica('Controle', 'Neste campo fica o método de controle d'.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Controle'.dicaF().'</a></th>';
if ($exibir['objetivo_melhorias']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_melhorias&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_melhorias' ? imagem('icones/'.$seta[$ordem]) : '').dica('Melhorias', 'Neste campo fica as melhorias efetuadas n'.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Melhorias'.dicaF().'</a></th>';
if ($exibir['objetivo_metodo_aprendizado']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_metodo_aprendizado&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_metodo_aprendizado' ? imagem('icones/'.$seta[$ordem]) : '').dica('Aprendizado', 'Neste campo fica o método de aprendizado n'.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Aprendizado'.dicaF().'</a></th>';
if ($exibir['objetivo_desde_quando']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_desde_quando&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_desde_quando' ? imagem('icones/'.$seta[$ordem]) : '').dica('Desde Quando', 'Neste campo fica desde quando é realizad'.$config['genero_objetivo'].' '.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Desde Quando'.dicaF().'</a></th>';
if ($exibir['objetivo_tipo_pontuacao']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.($tab ? '&tab='.$tab : '').'&ordenar=objetivo_tipo_pontuacao&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='objetivo_tipo_pontuacao' ? imagem('icones/'.$seta[$ordem]) : '').dica('Sistema de Pontuação', 'Neste campo fica o sisobjetivo de pontuação d'.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Sistema'.dicaF().'</a></th>';
...
if ($exibir['objetivo_dept']) echo '<th style="white-space: nowrap"><a href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.($tab ? '&tab='.$tab : '').'&a='.$a.'&ordenar=objetivo_dept&ordem='.($ordem ? '0' : '1').'\');" class="hdr">'.dica(ucfirst($config['departamento']), strtoupper($config['genero_dept']).' '.strtolower($config['departamento']).' responsável.').($ordenar=='objetivo_dept' ? imagem('icones/'.$seta[$ordem]) : '').ucfirst($config['departamento']).dicaF().'</a></th>';
...
foreach ($objetivos as $linha) {
	if (permiteAcessarObjetivo($linha['objetivo_acesso'],$linha['objetivo_id'])){
		...
		if ($exibir['objetivo_aprovado'] && $Aplic->profissional) echo '<td width=30 align="center">'.($linha['objetivo_aprovado'] && $linha['tem_aprovacao'] ? 'Sim' : ($linha['tem_aprovacao'] ? 'Não' : 'N/A')).'</td>';
		...
		if ($exibir['objetivo_dept']) echo '<td>'.link_secao($linha['objetivo_dept']).'</td>';	
