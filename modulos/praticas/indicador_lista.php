...
if (!$dialogo || $selecao){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$novo_indicador=($Aplic->checarModulo('praticas', 'adicionar', null, 'indicador') ? '<tr><td align=right>'.dica('Novo Indicador', 'Criar um novo indicador.').'<a href="javascript: void(0)" onclick="javascript:env.a.value=\'indicador_editar\'; env.submit();" ><img src="'.acharImagem('indicador_novo.png').'" border=0 width="16" heigth="16" /></a>'.dicaF().'</td></tr>' : '');
