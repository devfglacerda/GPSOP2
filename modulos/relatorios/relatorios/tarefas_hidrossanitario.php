...
$titulo = 'Lista de Tarefas de Engenharia Hidrossanitária';
if (!$dialogo){
...
/*FÁBIO AQUI */
	...
	echo '<table cellspacing=0 cellpadding="4" border=0 class="tbl1" align="center">';
		echo '<tr align="center"><td align="left"><b>Nome Tarefa</b></td><td><b>Solicitante</b></td><td><b>Designado</b></td><td><b>Início</b></td><td><b>Término</b></td><td><b>Porcentagem</b></td><td><b>Tipo</b></td><td><b>Status</b></td><td><b>Prioridade</b></td></tr>';
	...
	foreach ($tarefas as $tarefa) {
		...
		if ($atual_projeto_id != $tarefa['tarefa_projeto']) {
			echo '<tr><td colspan=9><b>'.link_projeto($tarefa['tarefa_projeto']).'</b></td>';
