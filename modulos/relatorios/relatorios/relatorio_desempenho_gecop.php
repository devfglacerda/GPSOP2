...
$titulo5=$data->format('%d/%m/%Y').' - Data de emissão do relatório';


$titulo4 ='<body>
<b
 style="color: rgb(0, 0, 0); font-family: Arial; font-size: 11px; font-style: normal; letter-spacing: normal; line-height: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255);"><br>
</b>
...
<b
 style="color: rgb(0, 0, 0); font-family: Arial; font-size: 11px; font-style: normal; letter-spacing: normal; line-height: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255);">Superintend&ecirc;ncias
de Obras P&uacute;blicas</b><br>
<b
...
Alberto Craveiro, 2775&nbsp; - Castel&atilde;o,
...
085 3295-6217 / 3295-6184</span><br
 style="color: rgb(0, 0, 0); font-family: Arial; font-size: 11px; font-style: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: 2; text-align: center; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(255, 255, 255);">
<span
...
$titulo2='<table align="center" cellspacing=0 width="790" cellpadding=0><tbody><tr><td
 style="text-align: left;" valign="undefined"><img
 style="width: 230px; height: 57px;" alt=""
 src="/estilo/rondon/imagens/logoDAE.png"></td><td
 style="text-align: right;" valign="undefined"><img
 style="width: 230px; height: 65px;" alt=""
 src="/estilo/rondon/imagens/logo_governo_estado.png"></td></tr></tbody></table>
<table align="center" style="font-size:10pt; padding-left: 5px; padding-right: 5px; " cellspacing=0 width="790" cellpadding=0>';
...
$titulo1=($usar_periodo ? $data_inicio->format('%d/%m/%Y').' à '.$data_fim->format('%d/%m/%Y') : $data->format('%d/%m/%Y')) ;
...
if (!$dialogo){
	...
	echo '</td>';
	echo ($dialogo ? '' : '<br><td width="32">'.dica('Imprimir o relatório', 'Clique neste ícone '.imagem('imprimir_p.png').' para abrir uma nova janela onde poderá imprimir o relatório a partir do navegador Web.').'<a href="javascript: void(0);" onclick="env.target=\'popup\'; env.dialogo.value=1; env.pdf.value=0; env.sem_cabecalho.value=0; env.submit();"><img src="'.acharImagem('imprimir.png').'" border=0 width="32" heigth="32" /></a>'.dicaF().'</td>');
...
else echo '<font size="4"><center>'.$titulo2.'</center></font>';
...
if ($fazer_relatorio || $dialogo) {
	...
	echo '<br><tr align="center"><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);" td colspan=9><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>RELATÓRIO DE DESEMPENHO INDIVIDUAL</b></td>';
													
	
	echo '<br><tr align="center"><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>DIRETORIA</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>GERÊNCIA</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>PROFISSIONAL</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>PERÍODO DAS ATIVIDADES</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>DATA DO RELATÓRIO</b></td>';
	
	echo '<br><tr align="center"><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Aline Sales</b><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Pedro Lisboa</b><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>'.link_usuario($usuario_id).'</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>'.$titulo1.'</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>'.$data->format('%d/%m/%Y').'</b></td>';
	
	//echo '<tr><td style="text-align: center; vertical-align: middle; background-color: rgb(218, 218, 218);" td colspan=2><b>'.link_usuario($usuario_id).'</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(218, 218, 218);" td colspan=2><b>'.link_usuario($usuario_id).'</b></td></tr>';
	...
	echo '<br><tr align="center"><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Demanda</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Início</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Término</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Tipo</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Solicitante</b></td>';
	$hrs = 'hrs';
	$qnt=0;
	foreach ($tarefas as $tarefa) {
		$qnt++;
		if ($atual_projeto_id != $tarefa['tarefa_projeto']) {
			echo '<tr><td style="background-color: rgb(218, 218, 218);" td colspan=9><b>'.link_projeto($tarefa['tarefa_projeto']).'</b></td>';
		...
		echo '<tr><td>&nbsp;&nbsp;&nbsp;'.link_tarefa($tarefa['tarefa_id']).'</td>';
		...
		echo '<td align="center">'.($tarefa['tarefa_inicio'] ? retorna_data($tarefa['tarefa_inicio'],false) : '&nbsp;').'</td><td align="center">'.($tarefa['tarefa_fim'] ? retorna_data($tarefa['tarefa_fim'],false) : '&nbsp;').'</td><td align="center">'.($tarefa['tarefa_tipo'] && isset($tipo[$tarefa['tarefa_tipo']]) ? $tipo[$tarefa['tarefa_tipo']] : '&nbsp;').'</td>
		
			
		<td align="center">'.($tarefa['projeto_setor'] && isset($tipo1[$tarefa['projeto_setor']]) ? $tipo1[$tarefa['projeto_setor']] : '&nbsp;').'</td>
...
//echo '<tr><td colspan=20><br><center>Relatório emitido em: '.'</td></tr>';echo date('d/m/Y');
	...
	echo estiloFundoCaixa();	
		...
		else echo '<font size="4"><center>'.$titulo4.'</center></font>';
