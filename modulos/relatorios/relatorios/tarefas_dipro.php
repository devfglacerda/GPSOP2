...
$sql->limpar();	}  	*/
	...
	echo '<br><tr align="center"><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Nome Tarefa</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Solicitante</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Tipo</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Status</b></td><td style="text-align: center; vertical-align: middle; background-color: rgb(4, 5, 4);"><span style="font-weight: bold; color: rgb(255, 255, 255);"><b>Prioridade</b></td></tr>';
	...
	foreach ($tarefas as $tarefa) {
		...
		echo '<td align="center">'.($tarefa['tarefa_tipo'] && isset($tipo[$tarefa['tarefa_tipo']]) ? $tipo[$tarefa['tarefa_tipo']] : '&nbsp;').'</td><td align="center">'.($tarefa['tarefa_status'] && isset($status[$tarefa['tarefa_status']]) ? $status[$tarefa['tarefa_status']] : '&nbsp;').'</td><td align="center">'.prioridade($tarefa['tarefa_prioridade']).'</td></tr>';
		}
