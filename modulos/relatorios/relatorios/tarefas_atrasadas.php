...
$sql->adOrdem('tarefa_fim, projeto_nome, tarefa_dono');
	...
	echo '<tr align="center"><td align="left"><b>Nome Tarefa</b></td><td><b>Responsável pel'.$config['genero_tarefa'].' '.$config['tarefa'].'</b></td><td><b>Designado</b></td><td><b>H. Aloc.</b></td><td><b>Início</b></td><td><b>Término</b></td><td><b>Percentagem</b></td><td><b>Tipo</b></td><td><b>Status</b></td><td><b>Secretaria</b></td><td><b>Prioridade</b></td></tr>';
	$hrs = 'hrs';
	$qnt=0;
	foreach ($tarefas as $tarefa) {
		...
		echo '<td align="center">'.(int)$tarefa['tarefa_duracao'].'</td><td align="center">'.($tarefa['tarefa_inicio'] ? retorna_data($tarefa['tarefa_inicio'],false) : '&nbsp;').'</td><td align="center">'.($tarefa['tarefa_fim'] ? retorna_data($tarefa['tarefa_fim'],false) : '&nbsp;').'</td><td align="center">'.(int)$tarefa['tarefa_percentagem'].'%'.'</td><td align="center">'.($tarefa['tarefa_tipo'] && isset($tipo[$tarefa['tarefa_tipo']]) ? $tipo[$tarefa['tarefa_tipo']] : '&nbsp;').'</td>
		
		<td align="center">'.($tarefa['tarefa_status'] && isset($status[$tarefa['tarefa_status']]) ? $status[$tarefa['tarefa_status']] : '&nbsp;').'</td>
		<td align="center">'.($tarefa['projeto_setor'] && isset($tipo1[$tarefa['projeto_setor']]) ? $tipo1[$tarefa['projeto_setor']] : '&nbsp;').'</td>
		<td align="center">'.prioridade($tarefa['tarefa_prioridade']).'</td>
