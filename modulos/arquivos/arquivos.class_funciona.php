...
class CArquivo extends CAplicObjeto {
    ...
    foreach ($usuarios as $usuario) {
        if (!isset($usado[$usuario['usuario_id']]) && !isset($usado[$usuario['contato_email']])) {
            ...
            if ($tipo != 'excluido') {
                $corpo .= '<br><a href="https://gpsop.sop.ce.gov.br/index.php?m=arquivos&a=ver&arquivo_id=' . $this->arquivo_id . '"><b>Clique para acessar o arquivo</b></a>';
            }
...
private function setResponderPara($email, $Aplic) {
    ...
    } elseif ($Aplic->usuario_email2 && $email->EmailValido($Aplic->usuario_email2)) {
