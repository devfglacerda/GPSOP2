...
echo '<tr>';
if ($tab==3) echo '<th>&nbsp;</th>';
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&tab='.$tab.'&ordenar=titulo&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='titulo' ? imagem('icones/'.$seta[$ordem]) : '').dica('Atividade', 'Nome da atividade.').'Atividade'.dicaF().'</th>';
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&tab='.$tab.'&ordenar=nota&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='nota' ? imagem('icones/'.$seta[$ordem]) : '').dica('Anotação da Atividade', 'Anotação da atividade.').'Anotação'.dicaF().'</th>';
...
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&tab='.$tab.'&ordenar=datafinal&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='datafinal' ? imagem('icones/'.$seta[$ordem]) : '').dica('Data Final', 'Data final estipulada para a execução da atividade.').'Data Final'.dicaF().'</th>';
if ($tab!=0 && $tab!=3) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&tab='.$tab.'&ordenar=data&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='data' ? imagem('icones/'.$seta[$ordem]) : '').dica('Data', 'Data em que a atividade foi aceita ou recusada.').'Data'.dicaF().'</th>';
echo '</tr>';
