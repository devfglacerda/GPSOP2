...
else if ($tipo=='tarefa_gantt') $endereco='m=tarefas&a=ver_gantt_pro&dialogo=1&projeto_id='.$projeto_id.'&auto_height=1';
else if ($tipo=='tarefa_ver') $endereco='m=tarefas&a=ver&dialogo=1&tarefa_id='.$id;
else if ($tipo=='tarefa_dashboard') $endereco='m=projetos&a=deshboard_geral_pro&jquery=1&dialogo=1&tarefa_id='.$id;
...
elseif ($tipo=='endereco' && $endereco) {
	$endereco=hexToStr($endereco);	
	}
else $endereco='';
