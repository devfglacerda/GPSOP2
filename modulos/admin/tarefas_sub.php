...
echo '<tr>';
	...
	echo '<th style="white-space: nowrap" width="140">'.dica('Status', 'Clique para ordenar '.$config['genero_tarefa'].'s '.$config['tarefas'].' abaixo pelo Status.');ordenar_por_titulo('Status', 'tarefa_status', SORT_NUMERIC, 'admin', 'a=ver_usuario', $usuario_id).dicaF().'</th>';
