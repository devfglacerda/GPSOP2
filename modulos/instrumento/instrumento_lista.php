...
if (!$dialogo || $selecao){	
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$imprimir='<tr><td align="right" style="white-space: nowrap">'.dica('Imprimir', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista de '.$config['instrumentos'].'.').'<a href="javascript: void(0);" onclick ="url_passar(1,\'m='.$m.'&a='.$a.'&dialogo=1\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
	...
	$procurar_tipo='<tr><td align="right" style="white-space: nowrap">'.dica('Tipo', 'Selecione qual o tipo de '.$config['instrumento'].'.').'Tipo:'.dicaF().'</td><td align="left" >'.selecionaVetor(getSisValor('TipoInstrumento'), 'instrumento_tipo', 'class="texto" style="width:250px" multiple', $instrumento_tipo).'</td></tr>';
	...
	$saida.='<tr><td valign=top><table cellspacing=0 cellpadding=0>'.$procurar_om.$procurar_envolvido.$procuraBuffer.$procurar_usuario.$procurar_ano.$procurar_tipo.$procurar_situacao.$favoritos.$popFiltro.$filtros.'</table></td><td valign=top><table cellspacing=0 cellpadding=0>'.$botao_filtrar.(!$selecao ? $novo.$imprimir.$botao_prioridade.$botao_excel.$botao_favorito.$botao_trava.$botao_campos : '').'</table></td></tr></table>';
	$saida.= '</div></div>';
