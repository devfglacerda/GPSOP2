...
elseif ($linha['msg_gestao_risco'] && $qnt==1) $endereco='m=praticas&a=risco_pro_ver&risco_id='.$linha['msg_gestao_risco'];
elseif ($linha['msg_gestao_risco_resposta'] && $qnt==1) $endereco='m=praticas&a=risco_resposta_pro_ver&risco_resposta_id='.$linha['msg_gestao_risco_resposta'];
...
elseif ($linha['msg_gestao_operativo'] && $qnt==1) $endereco='m=operativo&a=operativo_ver&operativo_id='.$linha['msg_gestao_operativo'];
...
elseif ($linha['msg_gestao_brainstorm'] && $qnt==1) $endereco='m=praticas&a=brainstorm_ver&brainstorm_id='.$linha['msg_gestao_brainstorm'];
elseif ($linha['msg_gestao_gut'] && $qnt==1) $endereco='m=praticas&a=gut_ver&gut_id='.$linha['msg_gestao_gut'];
elseif ($linha['msg_gestao_causa_efeito'] && $qnt==1) $endereco='m=praticas&a=causa_efeito_ver&causa_efeito_id='.$linha['msg_gestao_causa_efeito'];
...
elseif ($linha['msg_gestao_acao_item'] && $qnt==1) $endereco='m=praticas&a=plano_acao_item_ver&plano_acao_item_id='.$linha['msg_gestao_acao_item'];
elseif ($linha['msg_gestao_beneficio'] && $qnt==1) $endereco='m=projetos&a=beneficio_pro_ver&beneficio_id='.$linha['msg_gestao_beneficio'];
elseif ($linha['msg_gestao_painel_slideshow'] && $qnt==1) $endereco='m=praticas&a=painel_slideshow_pro_ver&jquery=1&painel_slideshow_id='.$linha['msg_gestao_painel_slideshow'];
elseif ($linha['msg_gestao_projeto_viabilidade'] && $qnt==1) $endereco='m=projetos&a=viabilidade_ver&projeto_viabilidade_id='.$linha['msg_gestao_projeto_viabilidade'];
elseif ($linha['msg_gestao_projeto_abertura'] && $qnt==1) $endereco='m=projetos&a=termo_abertura_ver&projeto_abertura_id='.$linha['msg_gestao_projeto_abertura'];
elseif ($linha['msg_gestao_plano_gestao'] && $qnt==1) $endereco='m=praticas&u=gestao&a=menu&pg_id='.$linha['msg_gestao_plano_gestao'];
