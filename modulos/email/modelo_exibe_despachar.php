...
$sql->limpar();
	...
	echo '<table align="center" cellspacing=2 width="790" cellpadding=2><tbody><tr><td style="text-align: left;" valign="undefined"><img style="width: 230px; height: 57px;" alt=""
 src="/estilo/rondon/imagens/logoDAE.png"></td><td style="text-align: right;" valign="undefined"><img style="width: 230px; height: 65px;" alt=""
...
echo '<tr><td colspan="5" align="center" style="font-size:12pt;"><b>Detalhes do processo</b></td></tr>';
echo '<tr><td align=center><table align="center" class="tbl1" cellspacing=0 width="100%" cellpadding=0>';
echo '<tr align=center><td><b>Número do Processo:</b></td><td>'.$modelo['modelo_protocolo'].'<td><b>Recebimento:</b></td><td>'.$modelo['modelo_data_protocolo'].'</td></table></td></tr>';
echo '<tr align=center></table></tr>';
...
echo '<tr><td colspan="5" align="center" style="font-size:12pt;"><b>Informações</b></td></tr>';
echo '<tr><td align=center><table align="center" class="tbl1" cellspacing=0 width="100%" cellpadding=0></table></td></tr>';
...
foreach ($sql_resultadosb as $rs_anot){ 
	if ($rs_anot['tipo'] == 1 ) { 
		...
		$saida.= '<tr id="2linha1_'.$rs_anot['modelo_anotacao_id'].'" style="display:none"><td style="font-size:8pt; padding-left: 5px; padding-right: 5px; background-color: #'.$cor['cor_despacho'].'"><table cellspacing=0 cellpadding=0><tr><td>';
...
if ($sql_resultadosf && count($sql_resultadosf)){
	echo '<table align="center" style="font-size:10pt; padding-left: 5px; padding-right: 5px; background-color: #'.$cor['cor_encamihamentos'].'" cellspacing=0 width="790" cellpadding=0>';
echo '<tr><td colspan="5" align="center" style="font-size:12pt;"><b>Tramitação interna do processo</b></td></tr>';
