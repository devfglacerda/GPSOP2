...
if (!count($linhas)) {
	...
	foreach ($linhas as $linha) {
		...
		echo '<tr><td>'.link_contato($linha['contato_id']).'</td><td>'.link_email($linha['contato_email'],$linha['contato_id']).'</td><td>'.$telefone.'</td><td>'.link_secao($contato->contato_dept).'</td><td>'.link_cia($linha['contato_cia']).'</td></tr>';
		}
	}
echo '</table>';
?>