...
if ($podeAcessar_email) {
		...
		//$menu->Add("Arquitetura","Eline Amorim",dica('Eline Amorim','Selecione esta opção para acessar as tarefas designadas.').'Eline Amorim'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=34\");", "estilo/rondon/imagens/icones/arquiteta.png");
			...
			$menu->Add("Arquitetura","Larrisa Figueiredo",dica('Larrisa Figueiredo','Selecione esta opção para acessar as tarefas designadas.').'Larrisa Figueiredo'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=43\");", "estilo/rondon/imagens/icones/arquiteta.png");
