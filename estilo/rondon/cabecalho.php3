...
//<header class=" main-header BgVerdeGrad ">;
	...
	if (!$dialogo){
		...
		$menu->Add("root","menu", dica('Menu','Exibir o o menu d'.$config['genero_organizacao'].' '.$config['organizacao'].'.').'Menu'.dicaF(), "javascript: void(0);", "estilo/rondon/imagens/icones/brazil.png");
...
$menu->Add("root",'entrada', dica('Caixa de Entrada', 'Leia '.$config['genero_mensagem'].'s '.$config['mensagens'].' na caixa de entrada.').'Mensagens'.($nao_lidas ? ' ('.$nao_lidas.'/'.$total_entrada.')' : ($total_entrada ? ' ('.$total_entrada.')' : '')).dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=email&a=lista_msg&status=1\");", "estilo/rondon/imagens/icones/email_receber.gif");
		...
		if ($config['doc_interno']){
			...
			$menu->Add("root",'doc_int', dica('Documentos Internos','Selecione esta opção para acessar os documentos criados dentro do '.$config['gpweb'].'.').'Processos '.($todas_entr ? ' ('.$todas_entr.($nao_lida ? '/'.$nao_lida: '').')': '').dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=email&a=modelo_pesquisar\");", "estilo/rondon/imagens/icones/msg10000.gif");
			}
...
if ($podeAcessar_email) {
		...
		$menu->Add("sistema","ajuda",dica('Ajuda','Selecione esta opção para acessar tutoriais e manuais do '.$config['gpweb'].'.').'Ajuda'.dicaF(), "javascript: void(0);' onclick='javascript:window.open(\"?m=ajuda&a=manual&dialogo=1\", \"Ajuda\", \"width=800, height=600, left=0, top=0, scrollbars=yes, resizable=yes\");", "estilo/rondon/imagens/icones/ajuda.gif");
			...
			$menu->Add("root",'Demandas por secretaria', dica('Demandas por secretaria','Selecione esta opção para acessar as tarefas de cada secretaria.').'Demandas por secretaria'.dicaF(), "javascript: void(0);", "estilo/rondon/imagens/icones/secretarias.png");
			...
			$menu->Add("Demandas por secretaria","SEJUS",dica('Controle de tarefas da SEJUS ','Selecione esta opção para acessar as tarefas da SEJUS.').'SEJUS'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=cias&a=ver_sejus&cia_id=3\");", "estilo/rondon/imagens/icones/tarefa_p.gif");
			...
			$menu->Add("Demandas por secretaria","SESPORTE",dica('Controle de tarefas da SESPORTE ','Selecione esta opção para acessar as tarefas da SESPORTE.').'SESPORTE'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=cias&a=ver_sesporte&cia_id=3\");", "estilo/rondon/imagens/icones/tarefa_p.gif");
			...
			$menu->Add("Demandas por secretaria","STDS",dica('Controle de tarefas da STDS ','Selecione esta opção para acessar as tarefas da STDS.').'STDS'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=cias&a=ver_stds&cia_id=3\");", "estilo/rondon/imagens/icones/tarefa_p.gif");
			...
			$menu->Add("root","Controle de Tarefas",dica('Controle de todas as tarefas','Selecione esta opção para acessar todas as tarefas da DIARQ.').'Controle de Tarefas'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=cias&a=ver&cia_id=3\");", "estilo/rondon/imagens/icones/tarefa.png");
				
						
			$menu->Add("Controle de Tarefas","Arquitetura",dica('Controle de tarefas da área de Arquitetura ','Selecione esta opção para acessar as tarefas da área de arquitetura.').'Arquitetura'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=7\");", "estilo/rondon/imagens/icones/arquitetura.png");
			
			//$menu->Add("Arquitetura","Gerente João Paulo",dica('Gerente João Paulo','Selecione esta opção para acessar as tarefas designadas.').'Gerente João Paulo'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=22\");", "estilo/rondon/imagens/icones/arquiteto.png");
			
		//$menu->Add("Arquitetura",'vazio0', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
		...
		//$menu->Add("Arquitetura","Wandemberg",dica('Wandemberg','Selecione esta opção para acessar as tarefas designadas.').'Wandemberg'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=48\");", "estilo/rondon/imagens/icones/arquiteto.png");
		   ...
		   //$menu->Add("Gerência de Engenharia",'vazio0', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
			...
			$menu->Add("Controle de Tarefas","Engenharia Estrutural",dica('Controle de tarefas da área de Estrutura ','Selecione esta opção para acessar as tarefas da área de estrutura.').'Estrutura'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=28\");", "estilo/rondon/imagens/icones/engenharia.png");
			...
			$menu->Add("Controle de Tarefas","Engenharia Mecânica",dica('Controle de tarefas da área de Mecânica ','Selecione esta opção para acessar as tarefas da área de Mecânica.').'Mecânica'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=29\");", "estilo/rondon/imagens/icones/mecaninca.png");
			...
			$menu->Add("Controle de Tarefas","Engenharia Hidrossanitária",dica('Controle de tarefas da área de Hidrossanitária ','Selecione esta opção para acessar as tarefas da área de Hidrossanitária.').'Hidrossanitária'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=27\");", "estilo/rondon/imagens/icones/pipe.png");
			...
			$menu->Add("Controle de Tarefas","Engenharia Elétrica",dica('Controle de tarefas da área de Elétrica ','Selecione esta opção para acessar as tarefas da área de Elétrica.').'Elétrica'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=26\");", "estilo/rondon/imagens/icones/eletrico.png");
			...
			$menu->Add("Controle de Tarefas","Orçamento",dica('Controle de tarefas da área de Orçamento ','Selecione esta opção para acessar as tarefas da área de Orçamento.').'Orçamento'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=30\");", "estilo/rondon/imagens/icones/orc.png");
			...
			//$menu->Add("Orçamento",'vazio0', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
			
		//  $menu->Add("Orçamento","Breno",dica('Breno','Selecione esta opção para acessar as tarefas designadas.').'Breno'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=82\");", "estilo/rondon/imagens/icones/arquiteto.png");
		//	$menu->Add("Orçamento","Estevam Ferreira",dica('Estevam Ferreira','Selecione esta opção para acessar as tarefas designadas.').'Estevam Ferreira'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=74\");", "estilo/rondon/imagens/icones/arquiteto.png");
	...
	//		$menu->Add("Orçamento","Paulo Artur",dica('Paulo Artur','Selecione esta opção para acessar as tarefas designadas.').'Paulo Artur'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=71\");", "estilo/rondon/imagens/icones/arquiteto.png");
			//$menu->Add("Orçamento","Pedro Jr.",dica('Pedro Jr.','Selecione esta opção para acessar as tarefas designadas.').'Pedro Jr.'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=126\");", "estilo/rondon/imagens/icones/arquiteto.png");
			...
			$menu->Add("Controle de Tarefas","Visão Geral",dica('Controle de tarefas em Geral ','Selecione esta opção para acessar as tarefas em geral.').'Visão Geral'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=cias&a=ver_geral&cia_id=3\");", "estilo/rondon/imagens/icones/tarefa_p.gif");
		...
		$menu->Add("Root","VIPROC",dica('VIPROC','Selecione para consultar processos no Viproc.').'VIPROC'.dicaF(), "javascript: void(0);' onclick='javascript:window.open(\"viproc.html\", \"Sobre\", \"width=700, height=600, left=0, top=0, scrollbars=yes, resizable=yes\");", "estilo/rondon/imagens/icones/informacao.gif");
