...
//echo '<meta http-equiv="C	ontent-Security-Policy" content="upgrade-insecure-requests">';
...
//if ($podeAcessar_email) $menu->Add("root",'entrada', dica('Caixa de Entrada', 'Leia '.$config['genero_mensagem'].'s '.$config['mensagens'].' na caixa de entrada.').'Mensagens'.($nao_lidas ? ' ('.$nao_lidas.'/'.$total_entrada.')' : ($total_entrada ? ' ('.$total_entrada.')' : '')).dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=email&a=lista_msg&status=1\");", "estilo/rondon/imagens/icones/email_receber.gif");
...
if ($podeAcessar_email) {
		...
		//$menu->Add("Arquitetura","Wandemberg",dica('Wandemberg','Selecione esta opção para acessar as tarefas designadas.').'Wandemberg'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=48\");", "estilo/rondon/imagens/icones/arquiteto.png");
		   ...
		   //$menu->Add("Gerência de Engenharia",'vazio0', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
			...
			$menu->Add("Engenharia Elétrica","Manoel Carlos",dica('Manoel Carlos','Selecione esta opção para acessar as tarefas designadas.').'Manoel Carlos'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=52\");", "estilo/rondon/imagens/icones/arquiteto.png");
		...
		echo $menu->Render();
		echo '</td></tr>';
		if (!$Aplic->celular) echo '<tr><td colspan="20" valign="top" style="background: url(estilo/rondon/imagens/nav_sombra.png);" align="left"><img width="1" height="13" src="estilo/rondon/imagens/nav_sombra.png"/></td></tr>';
		//echo '</table></td></tr>';
