...
if(!$Aplic->profissional){
  echo '<table width="100%" cellpadding=0 cellspacing=0 border=0>';
	...
	if (!$dialogo && $m!='email'){
		...
		echo '<tr class="nav"><td width="100%" nowrap="nowrap" style="background-color: #484040">';
		...
		if ($podeAcessar_email) {
			...
			$menu->Add("root",'Demandas por secretaria', dica('Demandas por secretaria','Selecione esta opção para acessar as tarefas de cada secretaria.').'Demandas por secretaria'.dicaF(), "javascript: void(0);", "estilo/rondon/imagens/icones/task_p.png");
			
			$menu->Add("Demandas por secretaria",'GOVERNADORIA', dica('Demandas da Governadoria.').'GOVERNADORIA'.dicaF(), "javascript: void(0);", "estilo/rondon/imagens/icones/task_p.png");
			...
			$menu->Add("root","Controle de Tarefas",dica('Controle de todas as tarefas','Selecione esta opção para acessar todas as tarefas da DIARQ.').'Controle de Tarefas'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=cias&a=ver&cia_id=3\");", "estilo/rondon/imagens/icones/task_p.png");
				
						
			$menu->Add("Controle de Tarefas","Arquitetura",dica('Controle de tarefas da área de Arquitetura ','Selecione esta opção para acessar as tarefas da área de arquitetura.').'Gerência de Arquitetura'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=7\");", "estilo/rondon/imagens/icones/arquitetura.png");
			...
			$menu->Add("Controle de Tarefas",'Gerência de Engenharia', 'Gerência de Engenharia');
		   ...
		   $menu->Add("Gerência de Engenharia",'vazio0', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
			...
			$menu->Add("Gerência de Engenharia","Engenharia Estrutural",dica('Controle de tarefas da área de Estrutura ','Selecione esta opção para acessar as tarefas da área de estrutura.').'Engenharia Estrutural'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=28\");", "estilo/rondon/imagens/icones/engenharia.png");
			...
			$menu->Add("Gerência de Engenharia","Engenharia Mecânica",dica('Controle de tarefas da área de Mecânica ','Selecione esta opção para acessar as tarefas da área de Mecânica.').'Engenharia Mecânica'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=29\");", "estilo/rondon/imagens/icones/engenharia.png");
			...
			$menu->Add("Gerência de Engenharia","Engenharia Hidrossanitária",dica('Controle de tarefas da área de Hidrossanitária ','Selecione esta opção para acessar as tarefas da área de Hidrossanitária.').'Engenharia Hidrossanitária'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=27\");", "estilo/rondon/imagens/icones/engenharia.png");
			...
			$menu->Add("Gerência de Engenharia","Engenharia Elétrica",dica('Controle de tarefas da área de Elétrica ','Selecione esta opção para acessar as tarefas da área de Elétrica.').'Engenharia Elétrica'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=26\");", "estilo/rondon/imagens/icones/engenharia.png");
			...
			$menu->Add("Controle de Tarefas","Orçamento",dica('Controle de tarefas da área de Orçamento ','Selecione esta opção para acessar as tarefas da área de Orçamento.').'Gerência de Orçamento'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=30\");", "estilo/rondon/imagens/icones/engenharia.png");
	...
	//Alterei aquiiiiiiiiiiiiiiiiiiiii
	...
	if (!$dialogo && $m=='email'){
		...
		if ($podeAcessar_email) {
			...
			if ($podeAcessar_tarefas)	$menu->Add("root","lista_projetos", dica('Lista de '.ucfirst($config['projetos']),'Exibir a lista de '.$config['projetos']).'Lista de '.$config['projetos'].dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=projetos&a=index\");", "estilo/rondon/imagens/icones/projeto_p.gif");
				
				
			if ($podeAcessar_tarefas) $menu->Add("root","tarefas", dica(ucfirst($config['tarefas']),'Exibir a lista de '.$config['tarefas']).ucfirst($config['tarefas']).dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=tarefas&a=index\");", "estilo/rondon/imagens/icones/tarefa_p.gif");
			...
			$menu->Add("Controle de Tarefas","Engenharia Estrutural",dica('Controle de tarefas da área de Estrutura ','Selecione esta opção para acessar as tarefas da área de estrutura.').'Engenharia Estrutural'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=28\");", "estilo/rondon/imagens/icones/engenharia.png");
			
			//$menu->Add("Engenharia Estrutural","Gerente Benício",dica('Gerente Benício','Selecione esta opção para acessar as tarefas designadas.').'Gerente Benício'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=20\");", "estilo/rondon/imagens/icones/arquiteto.png");
			...
			$menu->Add("Controle de Tarefas","Engenharia Mecânica",dica('Controle de tarefas da área de Mecânica ','Selecione esta opção para acessar as tarefas da área de Mecânica.').'Engenharia Mecânica'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=29\");", "estilo/rondon/imagens/icones/engenharia.png");
			
			$menu->Add("Engenharia Mecânica","Gerente Benício",dica('Gerente Benício','Selecione esta opção para acessar as tarefas designadas.').'Gerente Benício'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=20\");", "estilo/rondon/imagens/icones/arquiteto.png");
			
			$menu->Add("Engenharia Mecânica",'vazio0', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
			...
			$menu->Add("Engenharia Hidrossanitária","Gerente Benício",dica('Gerente Benício','Selecione esta opção para acessar as tarefas designadas.').'Gerente Benício'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=20\");", "estilo/rondon/imagens/icones/arquiteto.png");
			
			$menu->Add("Engenharia Hidrossanitária",'vazio0', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
			...
			$menu->Add("Controle de Tarefas","Engenharia Elétrica",dica('Controle de tarefas da área de Elétrica ','Selecione esta opção para acessar as tarefas da área de Elétrica.').'Engenharia Elétrica'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=26\");", "estilo/rondon/imagens/icones/engenharia.png");
			
			$menu->Add("Engenharia Elétrica","Gerente Benício",dica('Gerente Benício','Selecione esta opção para acessar as tarefas designadas.').'Gerente Benício'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=admin&a=tarefas&a=ver_usuario&usuario_id=20\");", "estilo/rondon/imagens/icones/arquiteto.png");
			
			$menu->Add("Engenharia Elétrica",'vazio0', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
			...
			$menu->Add("Controle de Tarefas","Orçamento",dica('Controle de tarefas da área de Orçamento ','Selecione esta opção para acessar as tarefas da área de Orçamento.').'Orçamento'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=depts&a=ver&dept_id=30\");", "estilo/rondon/imagens/icones/engenharia.png");
