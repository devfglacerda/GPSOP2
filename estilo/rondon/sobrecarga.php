...
function estiloTopoCaixa2($largura='100%', $link=''){
	global $Aplic, $config, $atualInfoTabId;
	if ($atualInfoTabId) return '';
	if ($Aplic->celular) return '<table width="'.$largura.'" cellspacing=0 cellpadding=0 border=0 align="center"><tr><td width="100%" style="1 #a6a6a6">&nbsp;</td></tr></table>';
	if (isset($config['estilo_css']) && $config['estilo_css']=='classico'){
		$ret = '<table width="'.$largura.'" cellspacing=0 cellpadding=0 border=0 align="center"><tr>';
		$ret .= '<td valign="bottom" height="17" style="background:url('.$link.'estilo/rondon/imagens/caixa_e2.png);" align="left"><img width="19" height="17" alt="" src="'.$link.'estilo/rondon/imagens/caixa_e2.png"/></td>';
		$ret .= '<td valign="bottom" width="100%" style="background:url('.$link.'estilo/rondon/imagens/caixa_m2.png);" align="left"><img width="19" height="17" alt="" src="'.$link.'estilo/rondon/imagens/caixa_m2.png"/></td>';
		$ret .= '<td valign="bottom" style="background:url('.$link.'estilo/rondon/imagens/caixa_d2.png);" align="right"><img width="19" height="17" alt="" src="'.$link.'estilo/rondon/imagens/caixa_d2.png"/></td>';
		$ret .= '</tr></table>';
		}
	else {
		$ret = '<table width="'.($largura ? $largura : '100%').'" cellspacing=0 cellpadding=0 border=0 align="center"><tr>';
...
function estiloFundoCaixa2($largura='100%', $link='', $tab='') {
	global $Aplic, $config;
	if ($Aplic->celular) return '<table width="'.$largura.'" cellspacing=0 cellpadding=0 border=0 align="center"><tr><td width="100%" style="background-color: #a6a6a6">&nbsp;</td></tr></table>';
	if (isset($config['estilo_css']) && $config['estilo_css']=='classico'){
		$ret = '<table width="'.$largura.'" cellspacing=0 cellpadding=0 border=0 align="center"><tr>';
		$ret .= '<td valign="top" height="35" style="background:url('.$link.'estilo/rondon/imagens/sombra_e2.png) no-repeat;" align="left"><img width="19" height="35" alt="" src="'.$link.'estilo/rondon/imagens/sombra_e2.png"/></td>';
		$ret .= '<td valign="top" width="100%" style="background: repeat-x url('.$link.'estilo/rondon/imagens/sombra_m2.png);" align="left"><img width="19" height="35" alt="" src="'.$link.'estilo/rondon/imagens/sombra_m2.png"/></td>';
		$ret .= '<td valign="top" style="background:url('.$link.'estilo/rondon/imagens/sombra_d2.png) no-repeat;" align="right"><img width="19" height="35" alt="" src="'.$link.'estilo/rondon/imagens/sombra_d2.png"/></td>';
		$ret .= '</tr></table>';
		}
	else {
		$ret = '<table width="'.($largura ? $largura : '100%').'" cellspacing=0 cellpadding=0 border=0 align="center"><tr>';
